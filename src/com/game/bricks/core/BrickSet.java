...
public class BrickSet {
	public BrickSet(int rows, int cols, Rectangle dimensions, DrawableManager drawableManager) {
	...
	public BorderCollision checkCollision(Rectangle rectangle, double delta) {
